...
#highr value of gamma more the model focuses on miclassified examples, alpha[weight0, wieght1]
...
def build_model(hp):
    ...
    out = Conv2D(1, (1, 1), activation='sigmoid')(conv7)
...
with open('/rds/general/user/nmk120/home/Mod_HypP/4/GridS_L_mod_hyperParam_metrics.txt', 'w') as f:
