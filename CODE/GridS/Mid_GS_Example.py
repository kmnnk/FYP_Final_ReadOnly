...
#2nd deepest model function
def build_model(hp):
    inputs = Input((200, 200, 1024))
    x = Conv2D(4, (1, 1))(inputs)

    conv1 = Conv2D(64, (3, 3), activation='relu', padding='same')(x)
    conv1 = Conv2D(64, (3, 3), activation='relu', padding='same')(conv1)
    # conv1 = Dropout(0.25)(conv1)  # Dropout added after convolution
    pool1 = MaxPooling2D(pool_size=(2, 2))(conv1)

    conv2 = Conv2D(128, (3, 3), activation='relu', padding='same')(pool1)
    conv2 = Conv2D(128, (3, 3), activation='relu', padding='same')(conv2)
    # conv2 = Dropout(0.5)(conv2)  # Dropout added after convolution
    ...
    out = Conv2D(1, (1, 1), activation='sigmoid')(conv5)
    ...
    model.compile(optimizer='adam', 
                  loss = focal_loss(alpha=[alpha1, alpha2], gamma=hp.Float('gamma', 0.0, 5.0, step=0.1)), 
...
tuner = GridSearch(
    ...
    max_trials=4050, #at least this to try all combs: 4 alpha * 4 alpha * 11 gamma values = 176
...
with open('/rds/general/user/nmk120/home/Mod_HypP/4/GridS_M_mod_hyperParam_metrics.txt', 'w') as f:
    ...
    for threshold in [0.38, 0.42, 0.46, 0.48, 0.52]:  # replace with your thresholds
